...
#  (c) 2018 Dan Pool (dpdp) parts based on work by meta-androcto  parts based on work by Saidenka,
# Materials Utils by MichaleW Materials Conversion: Silvio Falcinelli#
import bpy
...
bl_info = {
    ...
    "location": "Properties > Material > Specials > CadMatClean",
    "warning": "",
    "wiki_url": "",
    "tracker_url": "",
    "category": "Object"}
...
class CadMatClean(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        sob = context.object.active_material_index  # type: object
...
def register():
    bpy.utils.register_class(CadMatClean)
